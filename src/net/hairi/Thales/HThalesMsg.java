...
import net.hairi.Thales.HThalesKeyScheme;
 ...
 * @since 1.4.7
 */
public class HThalesMsg  implements Loggeable, Cloneable {
     ...
     */
    public HThalesMsg (String basePath) {
     ...
     */
    public HThalesMsg (String basePath, String baseSchema) {
...
//         System.out.println ("++++ "+fieldName + ":" + fieldValue + " " + type + "," + isBinary(type));
    ...
    public void copy (String fieldName, HThalesMsg msg) {
    ...
    public Object clone() {
        try {
            HThalesMsg m = (HThalesMsg) super.clone();
    ...
    public void merge (HThalesMsg m) {
